---
title: mgaps-website compiler
---

# The MGAPS website compiler

This is the official manual for the `mgaps-website` compiler. 
...
If you have any questions, feel free to e-mail me at [laurent.renedecotret@mail.mcgill.ca](mailto:laurent.renedecotret@mail.mcgill.ca).
...
This manual has been built using the pandoc LaTeX template [Eisvogel](https://github.com/Wandmalfarbe/pandoc-latex-template).